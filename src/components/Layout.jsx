            ...
            >
                ...
                <nav className="flex-1 space-y-2">
                    <SidebarItem
                        ...
                        label="Builder"
                        path="/"
                        active={location.pathname === '/' || location.pathname === '/builder'}
                    />
                    <SidebarItem
                        icon={History}
                        label="History"
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-4 text-xs font-medium px-4 py-2 rounded-full bg-white/50 dark:bg-black/20 border border-gray-200 dark:border-gray-800 backdrop-blur-sm">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-gray-600 dark:text-gray-400">Kimi-K2P5</span>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-gray-600 dark:text-gray-400">Kimi-Instruct</span>
                            </div>
                        </div>
